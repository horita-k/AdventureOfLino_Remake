...
//ジグザグのランダム幅
//float ThunderRand = 800;
float ThunderRand = 400;

//ジグザグの範囲
float ThunderRange = 1;
...
//射出時の勢い
float3 StartSpd	=  float3(0.0, 0.0, 0.0);
//着弾時の勢い
float3 EndSpd 	=  float3(0.0, 0.0, 0.0);

//テクスチャ名
texture LightningEx_Tex0
<
   string ResourceName = "LightningEx0.png";
>;
